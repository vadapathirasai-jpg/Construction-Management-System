...
import { Badge, Button, Card, EmptyState, Field, Icon, LoadingState, Modal, PageHeader, StatusBadge, Table } from "../components/UI";
...
export function Reports() {
  ...
  const visibleExpenses = expenses.filter((expense) => names.includes(expense.project));
